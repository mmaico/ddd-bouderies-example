package com.crm.infrastructure.helpers.businessmodel.reflections.registers;
...
public class CollectionsImplementationRegister {
  ...
  private static final Map<Class<? extends Collection>, Class<? extends Collection>> collectionImplementations = new HashMap<>();
